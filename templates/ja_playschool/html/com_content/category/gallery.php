...
<div class="blog<?php echo $this->pageclass_sfx;?>">
	...
	<div class="ja-gallery-list-wrap">
		<?php if (version_compare(JVERSION, '4.0', 'ge')): ?>
			<?php echo JLayoutHelper::render('joomla.content.gallery_play_j4', $result[0]); ?>
		<?php else: ?>
	...
	<?php foreach ($result as $key => &$item) : ?>
		...
		<?php endif; ?>
			<div class="col col-sm-<?php echo round((12 / $this->columns));?> <?php echo $item->state == 0 ? ' system-unpublished' : null; ?>">
				<div class="item">
						<?php
						$this->item = &$item;
